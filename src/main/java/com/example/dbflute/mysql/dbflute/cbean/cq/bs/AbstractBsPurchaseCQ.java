...
public abstract class AbstractBsPurchaseCQ extends AbstractConditionQuery {
     ...
     * <pre>
     * cb.query().<span style="color: #FD4747">existsPurchaseSelfAsOne</span>(new SubQuery&lt;PurchaseCB&gt;() {
     *     public void query(PurchaseCB subCB) {
     *         subCB.query().setXxx...
     *     }
     * });
     * </pre>
     * @param subQuery The sub-query of PurchaseSelfAsOne for 'exists'. (NotNull)
     */
    public void existsPurchaseSelfAsOne(SubQuery<PurchaseCB> subQuery) {
        ...
        String subQueryPropertyName = keepPurchaseId_ExistsReferrer_PurchaseSelfAsOne(cb.query()); // for saving query-value.
        registerExistsReferrer(cb.query(), "PURCHASE_ID", "PURCHASE_ID", subQueryPropertyName, "purchaseSelfAsOne");
    }
    public abstract String keepPurchaseId_ExistsReferrer_PurchaseSelfAsOne(PurchaseCQ subQuery);
     ...
     * (購入)purchase by PURCHASE_ID, named 'purchaseSelfAsOne'.
     * <pre>
     * cb.query().<span style="color: #FD4747">notExistsPurchaseSelfAsOne</span>(new SubQuery&lt;PurchaseCB&gt;() {
     *     public void query(PurchaseCB subCB) {
     *         subCB.query().setXxx...
     *     }
     * });
     * </pre>
     * @param subQuery The sub-query of PurchaseId_NotExistsReferrer_PurchaseSelfAsOne for 'not exists'. (NotNull)
     */
    public void notExistsPurchaseSelfAsOne(SubQuery<PurchaseCB> subQuery) {
        assertObjectNotNull("subQuery<PurchaseCB>", subQuery);
        PurchaseCB cb = new PurchaseCB(); cb.xsetupForExistsReferrer(this); subQuery.query(cb);
        String subQueryPropertyName = keepPurchaseId_NotExistsReferrer_PurchaseSelfAsOne(cb.query()); // for saving query-value.
        registerNotExistsReferrer(cb.query(), "PURCHASE_ID", "PURCHASE_ID", subQueryPropertyName, "purchaseSelfAsOne");
    }
    public abstract String keepPurchaseId_NotExistsReferrer_PurchaseSelfAsOne(PurchaseCQ subQuery);

    /**
     * Set up InScopeRelation (sub-query). <br />
     * {in (select PURCHASE_ID from purchase where ...)} <br />
     * (購入)purchase by my PURCHASE_ID, named 'purchaseSelf'.
     * @param subQuery The sub-query of PurchaseSelf for 'in-scope'. (NotNull)
     */
    public void inScopePurchaseSelf(SubQuery<PurchaseCB> subQuery) {
        assertObjectNotNull("subQuery<PurchaseCB>", subQuery);
        PurchaseCB cb = new PurchaseCB(); cb.xsetupForInScopeRelation(this); subQuery.query(cb);
        String subQueryPropertyName = keepPurchaseId_InScopeRelation_PurchaseSelf(cb.query()); // for saving query-value.
        registerInScopeRelation(cb.query(), "PURCHASE_ID", "PURCHASE_ID", subQueryPropertyName, "purchaseSelf");
    }
    public abstract String keepPurchaseId_InScopeRelation_PurchaseSelf(PurchaseCQ subQuery);

    /**
     * Set up InScopeRelation (sub-query). <br />
     * {in (select PURCHASE_ID from purchase where ...)} <br />
     * (購入)purchase by PURCHASE_ID, named 'purchaseSelfAsOne'.
     * @param subQuery The sub-query of PurchaseSelfAsOne for 'in-scope'. (NotNull)
     */
    public void inScopePurchaseSelfAsOne(SubQuery<PurchaseCB> subQuery) {
        assertObjectNotNull("subQuery<PurchaseCB>", subQuery);
        PurchaseCB cb = new PurchaseCB(); cb.xsetupForInScopeRelation(this); subQuery.query(cb);
        String subQueryPropertyName = keepPurchaseId_InScopeRelation_PurchaseSelfAsOne(cb.query()); // for saving query-value.
        registerInScopeRelation(cb.query(), "PURCHASE_ID", "PURCHASE_ID", subQueryPropertyName, "purchaseSelfAsOne");
    }
    public abstract String keepPurchaseId_InScopeRelation_PurchaseSelfAsOne(PurchaseCQ subQuery);

    /**
     * Set up NotInScopeRelation (sub-query). <br />
     * {not in (select PURCHASE_ID from purchase where ...)} <br />
     * (購入)purchase by my PURCHASE_ID, named 'purchaseSelf'.
     * @param subQuery The sub-query of PurchaseSelf for 'not in-scope'. (NotNull)
     */
    public void notInScopePurchaseSelf(SubQuery<PurchaseCB> subQuery) {
        assertObjectNotNull("subQuery<PurchaseCB>", subQuery);
        PurchaseCB cb = new PurchaseCB(); cb.xsetupForInScopeRelation(this); subQuery.query(cb);
        String subQueryPropertyName = keepPurchaseId_NotInScopeRelation_PurchaseSelf(cb.query()); // for saving query-value.
        registerNotInScopeRelation(cb.query(), "PURCHASE_ID", "PURCHASE_ID", subQueryPropertyName, "purchaseSelf");
    }
    public abstract String keepPurchaseId_NotInScopeRelation_PurchaseSelf(PurchaseCQ subQuery);

    /**
     * Set up NotInScopeRelation (sub-query). <br />
     * {not in (select PURCHASE_ID from purchase where ...)} <br />
     * (購入)purchase by PURCHASE_ID, named 'purchaseSelfAsOne'.
     * @param subQuery The sub-query of PurchaseSelfAsOne for 'not in-scope'. (NotNull)
     */
    public void notInScopePurchaseSelfAsOne(SubQuery<PurchaseCB> subQuery) {
        assertObjectNotNull("subQuery<PurchaseCB>", subQuery);
        PurchaseCB cb = new PurchaseCB(); cb.xsetupForInScopeRelation(this); subQuery.query(cb);
        String subQueryPropertyName = keepPurchaseId_NotInScopeRelation_PurchaseSelfAsOne(cb.query()); // for saving query-value.
        registerNotInScopeRelation(cb.query(), "PURCHASE_ID", "PURCHASE_ID", subQueryPropertyName, "purchaseSelfAsOne");
    }
    public abstract String keepPurchaseId_NotInScopeRelation_PurchaseSelfAsOne(PurchaseCQ subQuery);
