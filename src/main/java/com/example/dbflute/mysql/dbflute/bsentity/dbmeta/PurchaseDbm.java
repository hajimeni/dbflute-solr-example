...
public class PurchaseDbm extends AbstractDBMeta {
    ...
    //                                                                         Column Info
    //                                                                         ===========
    protected final ColumnInfo _columnPurchaseId = cci("PURCHASE_ID", "PURCHASE_ID", null, "購入ID", true, "purchaseId", Long.class, true, true, "BIGINT", 19, 0, null, false, null, "連番", "purchaseSelf,purchaseSelfAsOne", "", null);
    protected final ColumnInfo _columnMemberId = cci("MEMBER_ID", "MEMBER_ID", null, "会員ID", true, "memberId", Integer.class, false, false, "INT", 10, 0, null, false, null, "会員を参照するID。\n購入を識別する自然キー（複合ユニーク制約）の筆頭要素。", "member,memberAddressAsSkipRelation", null, null);
    protected final ColumnInfo _columnProductId = cci("PRODUCT_ID", "PRODUCT_ID", null, "商品ID", true, "productId", Integer.class, false, false, "INT", 10, 0, null, false, null, "商品を参照するID。", "product", null, null);
    ...
    public ForeignInfo foreignPurchaseSelf() {
        ...
        return cfi("FK_PURCHASE_PURCHASE_SELF", "purchaseSelf", this, PurchaseDbm.getInstance(), map, 2, true, false, false, true, null, null, false, "purchaseSelfAsOne");
    }
    public ForeignInfo foreignMemberAddressAsSkipRelation() {
        ...
        return cfi("FK_PURCHASE_MEMBER_ADDRESS_VALID", "memberAddressAsSkipRelation", this, MemberAddressDbm.getInstance(), map, 3, false, false, false, true, "$$foreignAlias$$.VALID_BEGIN_DATE <= /*$$locationBase$$.parameterMapMemberAddressAsSkipRelation.targetDate*/null\n     and $$foreignAlias$$.VALID_END_DATE >= /*$$locationBase$$.parameterMapMemberAddressAsSkipRelation.targetDate*/null", newArrayList("targetDate"), false, null);
    }
    public ForeignInfo foreignPurchaseSelfAsOne() {
        Map<ColumnInfo, ColumnInfo> map = newLinkedHashMap(columnPurchaseId(), PurchaseDbm.getInstance().columnPurchaseId());
        return cfi("FK_PURCHASE_PURCHASE_SELF", "purchaseSelfAsOne", this, PurchaseDbm.getInstance(), map, 4, true, false, true, true, null, null, false, "purchaseSelf");
    }
